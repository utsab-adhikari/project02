    ...
    <div className="p-4 sm:p-8 space-y-8 sm:space-y-10 min-h-screen text-gray-100 font-inter">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-8">
        <div className="bg-gray-800 p-6 rounded-lg shadow-lg text-center">
          ...
          <p className="text-4xl sm:text-5xl font-semibold text-purple-400">
            {activeUsers}
          </p>
        </div>
        <div className="bg-gray-800 p-6 rounded-lg shadow-lg text-center">
          ...
          <p className="text-4xl sm:text-5xl font-semibold text-green-400">
            {newUsers}
          </p>
        </div>
        <div className="bg-gray-800 p-6 rounded-lg shadow-lg text-center">
          ...
          <p className="text-4xl sm:text-5xl font-semibold text-red-400">
            {bounceRate}%
          </p>
        </div>
        <div className="bg-gray-800 p-6 rounded-lg shadow-lg text-center">
          ...
          <p className="text-4xl sm:text-5xl font-semibold text-blue-400">
          ...
          <ul className="space-y-2 max-h-80 overflow-y-auto custom-scrollbar">
            {topPages.length > 0 ? (
              topPages.map((p, i) => (
                <li
                  key={i}
                  className="flex justify-between items-center text-gray-300 border-b border-gray-700 pb-2 last:border-b-0"
                >
                  <span className="flex-1 truncate pr-2 text-sm sm:text-base">
                    {p.path}
                  </span>
          ...
          <div className="max-h-[400px] overflow-y-auto custom-scrollbar">
            <table className="min-w-full bg-gray-700 rounded-lg shadow-inner">
              <thead className="sticky top-0 bg-gray-600">
                <tr>
                  <th className="py-2 px-4 text-left text-gray-200 font-semibold rounded-tl-lg">
                    Country
                  </th>
                  <th className="py-2 px-4 text-left text-gray-200 font-semibold">
                    City
                  </th>
                  <th className="py-2 px-4 text-left text-gray-200 font-semibold rounded-tr-lg">
                    Users
                  </th>
                </tr>
              </thead>
              <tbody>
                {locations.length > 0 ? (
                  locations.map((loc, i) => (
                    <tr
                      key={i}
                      className="border-b border-gray-600 last:border-b-0 hover:bg-gray-600 transition-colors"
                    >
                  ...
                  <tr>
                    <td colSpan="3" className="py-4 text-center text-gray-400">
                      No real-time user locations available.
                    </td>
                  </tr>
                )}
              </tbody>
