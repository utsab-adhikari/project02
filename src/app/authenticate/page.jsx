...
export default function Page() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-10 text-white font-inter">
      <div className="bg-gray-900 border border-indigo-600/30 rounded-3xl p-8 sm:p-12 shadow-2xl w-full max-w-md text-center mx-auto relative overflow-hidden transform transition-all duration-300 hover:scale-[1.01] hover:shadow-indigo-500/20">
